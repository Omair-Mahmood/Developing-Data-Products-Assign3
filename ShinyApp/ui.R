...
shinyUI(
    navbarPage("Shiny Application",
               tabPanel("Analysis",
                        fluidPage(
                            titlePanel("Let us explore the relationship between variables and miles per gallon (MPG)"),
                            sidebarLayout(
                                sidebarPanel(
               ...
               tabPanel("About the Data Set",
                        ...
                        h3("Regression Models Reference taken from a Course Project in Coursera)"),
                        ...
                        h3("Important"),
                        p("A data frame with 32 observations on 11 variables is considered."),
               ...
               tabPanel("Step back to my Github repository",
                        a("https://github.com/omair-mahmood/Developing-Data-Products-Assign3"),
                        hr(),
                        h4("I hope you have enjoyed the Shiny App, Keep Rocking and Keep Driving"),
                        h4(" "),
                        h4("The name of the repository is Developing Data Products Assign3")
               )
    )
)
